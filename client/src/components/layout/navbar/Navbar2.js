    ...
    <ul className="nav__menu">
      ...
      <li className="nav__menu-item">
        {this.props.loggedInUser ? (
          <Link className="nav-link nav__menu-item" to="/account/profile">
            <img className="cart-img" src={user} />
            <ProfileDrop />
          </Link>
        ) : (
          <Link className="nav-link nav__menu-item" to="/account/login">
            <img className="cart-img" src={user} />
          </Link>
        )}
      </li>
